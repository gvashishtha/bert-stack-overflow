...
def main(_):
    ...
    # Get labels
    labels = pd.read_csv(
        os.path.join(FLAGS.data_dir, 'classes.txt'),
        header=None)
    ...
    train_dataset = get_dataset(
        os.path.join(FLAGS.data_dir, 'train.csv'),
        tokenizer, FLAGS.max_seq_length, labels_map)
    valid_dataset = get_dataset(
        os.path.join(FLAGS.data_dir, 'valid.csv'),
        tokenizer, FLAGS.max_seq_length, labels_map)
    test_dataset = get_dataset(
        os.path.join(FLAGS.data_dir, 'test.csv'),
        tokenizer, FLAGS.max_seq_length, labels_map)
